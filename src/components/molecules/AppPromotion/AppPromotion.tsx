...
export const AppPromotion: React.FC<AppPromotionProps> = ({ isMobile = false }) => {
  if (isMobile) {
    return (
      <div className="bg-neutral-50 box-border content-stretch flex flex-col gap-6 items-center justify-center px-8 py-12 relative shrink-0 w-[375px]">
  ...
  // Desktop version
  return (
    <div className="box-border content-stretch flex flex-row gap-16 items-center justify-start p-0 relative rounded-[20px] shrink-0 w-[1280px]">
      {/* App Screenshots */}
      <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
